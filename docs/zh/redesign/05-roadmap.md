...
> **状态（2026-09）**：P0–P4 已全部交付（事件契约 v1、控制面、风控闭环、商业化与智能化），实际落地明细以仓库根 `todo.md` 为准——P5 报表看板、P6 实验/Crash/智能化、P7 竞品差距收敛均已完成（发布说明见 [release-notes/v0.2.0.md](../../release-notes/v0.2.0.md)），P8 MMP 归因有条件立项处于暂停项。本文档保留为设计期路线回溯，不再更新进度。
