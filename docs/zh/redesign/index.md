...
| 文档 | 内容 |
|---|---|
| [01-assessment](./01-assessment) | 现状评估：当前代码和文档中多租户/Project/Game 混杂的问题 |
| [02-design-issues](./02-design-issues) | 关键设计问题：必须移除的复杂度和必须补齐的游戏能力 |
...
- `oddsmaker_completion_assessment.md`
- `oddsmaker_technical_recommendations.md`
- `oddsmaker_quick_summary.md`
- `ASSESSMENT_INDEX.md`
