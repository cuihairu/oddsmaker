...
CREATE TABLE sampling_policies (
    ...
    default_sample_rate DOUBLE PRECISION DEFAULT 1.0,
    ...
    effective_sample_rate DOUBLE PRECISION DEFAULT 1.0,
...
CREATE TABLE event_sampling_rules (
    ...
    min_sample_rate DOUBLE PRECISION DEFAULT 0.0,
    max_sample_rate DOUBLE PRECISION DEFAULT 1.0,
