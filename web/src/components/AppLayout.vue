...
const navigation = [
  ...
  { name: '自定义仪表盘', href: '/analytics/dashboards', icon: 'grid' },
...
const iconPaths = {
  ...
  steps: 'M5 5h5v5H5V5zm4.5 4.5h5v5h-5v-5zm4.5 4.5h5v5h-5v-5z',
  bolt: 'M13 10V3L4 14h7v7l9-11h-7z',
  grid: 'M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM14 13a1 1 0 011-1h4a1 1 0 011 1v6a1 1 0 01-1 1h-4a1 1 0 01-1-1v-6z',
  terminal: 'M8 9l3 3-3 3m5 0h3M5 5h14a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2z',
